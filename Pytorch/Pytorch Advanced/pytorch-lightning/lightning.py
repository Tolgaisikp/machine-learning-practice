...
# bizim verileri yüklememiz, dataloaderlar, validation_step ve validation_epoch_end işlemlerini pytorch lightning ile kolaylaştırma
# aynı zamanda eğitim sırasında tpu cpu gibi işlevleri kullanmamızı kolaylaştırır pytorch lighting kütüphanesinde hazır fonksiyonlar
# olarak bulunurlar.
